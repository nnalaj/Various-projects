...
const resumeData = {
        ...
        skills:  ["./logos/c#.png", "./logos/CSS.png", "./logos/html.png","./logos/java.png","./logos/JS.png","./logos/mongodb.png","./logos/sql.png","./logos/"],
        work: " ",
        ...
        <div className='ResumeBlock'>
            <div className='ResumeContent'>
                ...
                <table>
                    ...
                    <tr>
                        <td>{resumeData.skills[0]} </td>    {/*vertical layout with pngs underneath  */}
                        <td>{resumeData.skills[1]} </td>
                        <td>{resumeData.skills[2]} </td>
                    </tr>
                </table>
